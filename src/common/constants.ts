...
export const UPDATE_FB_AD_ACCOUNT_ID_URL = ROOT_URL + "/mobile-game-submission/facebook-details/update/fbAdAccountId"
export const CREATE_SDK_INTEGRATION_DATA_URL = ROOT_URL + "/mobile-game-submission/sdk-integration/new"
...
export const DOWNLOAD_WEB_GAME_CREATIVES_DATA_URL = ROOT_URL + "/web-game-submission/creatives/download"

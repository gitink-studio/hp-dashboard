...
import { MobileGameSubmissionForm } from './mobile-game-submission-form/mobile-game-submission-form';
...
import { useActiveStep, useCurrentGameSetupDetails, useCurrentStep, useMobileGameSubmissionActions } from '../../store/mobile-game-submission/sdk-details-store';
import { useValidateMobileGameSubmissionFormInputs } from '../../store/mobile-game-submission/mobile-game-submission-form-store';

export const SDKDetails = () => {
    const currentStep = useCurrentStep();
    const activeStep = useActiveStep();
    const validateGameSubmissionInputs = useValidateMobileGameSubmissionFormInputs();
    const currentSetupGameDetails = useCurrentGameSetupDetails();
    const { setActiveStep, setCurrentStepWithIndex, isStepCompleted } = useMobileGameSubmissionActions();
    let isStepSet = false;

    const stepContentList = [
        { component: <MobileGameSubmissionForm />, isAllDataEntered: validateGameSubmissionInputs },

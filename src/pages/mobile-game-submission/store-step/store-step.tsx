...
import { useActiveStep, useCurrentGameSetupDetails, useCurrentStep, useDataSending, useMobileGameSubmissionActions } from "../../../store/mobile-game-submission/sdk-details-store";
import { useDisplayAdvertisingID, useDisplayPrivacyGuide, useIsAdvertisingIDAnswered, useIsAllFieldsFilled, useIsAppAvailableInAllStores, useIsPrivacyGuideAnswered, useStoreStepActions } from "../../../store/mobile-game-submission/store-step-store";
...
export const StoreStep: React.FC = () => {
    ...
    const { isStepCompleted, setCurrentStep, setDataSending, setCurrentGameSetupDetails } = useMobileGameSubmissionActions();

...
import { useAdvancedAppStepCompleted, useAppId, useBasicAppStepCompleted, useClientToken, useFacebookSetupActions, useNewAppStepCompleted, useProgress, useReferrerDecryptionKey } from '../../../store/mobile-game-submission/facebook-setup-store';
import { useNotify } from 'react-admin';
import { UPDATE_FB_DATA_URL, CREATE_MOBILE_GAME_SUBMISSION_DATA_URL, CURRENT_SDK_SETUP_STATE_ID, FB_APP_ID_LENGTH, HttpMethod, MINIMUM_FB_CLIENT_TOKEN_LENGTH, MINIMUM_FB_REFERRER_DECRYPTION_KEY, SDK_SETUP_GAME_ID, STUDIO_TOKEN } from '../../../common/constants';
...
export const FacebookSetupStep: React.FC = () => {
    ...
    const { setCurrentStep, setDataSending, setCurrentGameSetupDetails } = useMobileGameSubmissionActions();

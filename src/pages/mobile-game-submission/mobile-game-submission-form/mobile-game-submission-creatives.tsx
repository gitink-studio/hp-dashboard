...
import { useGameIconFile, useGamePlayVideoFile, useMobileGameSubmissionFormActions, useStoreStatus } from "../../../store/mobile-game-submission/mobile-game-submission-form-store";
import { customStyle } from "../../../common/styles";

const MobileGameSubmissionCreatives = () => {
    const notify = useNotify();
    const storeStatus = useStoreStatus();
    const gameIconFile = useGameIconFile();
    const [videoFile, setVideoFile] = useState<File | null>(null);
    const { setGameIconFile, setGamePlayVideoFile } = useMobileGameSubmissionFormActions();
...
export default MobileGameSubmissionCreatives;

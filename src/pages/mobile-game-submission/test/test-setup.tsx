...
import { useActiveStep, useCurrentGameSetupDetails, useDataSending, useMobileGameSubmissionActions } from "../../../store/mobile-game-submission/sdk-details-store";
import { useDisplayCreativeLibrary, useTestSetupActions, useVideoFiles } from "../../../store/mobile-game-submission/test-setup-store";
...
export const TestSetup: React.FC = () => {
    ...
    const { isStepCompleted, setCurrentStep, setDataSending } = useMobileGameSubmissionActions();
    ...
    const submitData = async () => {
        try {
            ...
            let response = await sendFormDataRequest('upload-creatives-data', CREATE_TEST_SETUP_DATA_URL, videoFiles, {
                ...
                androidOrIOSGameRequestDetailsId: currentGameSetupDetails.androidOrIOSGameRequest.androidOrIOSGameRequestDetails.id,

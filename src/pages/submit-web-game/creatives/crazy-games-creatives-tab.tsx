    ...
    const creativesImage = [
        {
            content: {
                label: "Banners",
                requirements: [
                    { label: "Landscape", preview: largeLandscapeBannerPreviewImageName, setPreview: setLargeLandscapeBannerPreviewImageName, width: 1920, height: 1080, value: bannerImageName, setValue: setBannerImageName },
                    { label: "Portrait", preview: portraitBannerPreviewImageName, setPreview: setPortraitBannerPreviewImageName, width: 800, height: 1200, value: portraitBannerPreviewImageName, setValue: setPortraitBannerPreviewImageName },
                    { label: "Square", preview: squareBannerPreviewImageName, setPreview: setSquareBannerPreviewImageName, width: 800, height: 800, value: squareBannerPreviewImageName, setValue: setSquareBannerPreviewImageName },
                ]
            },
        },
    ]
    ...
    const creativesVideo = [
        {
            content: {
                ...
                requirements: [
                    ...
                    { label: "Portrait", width: 800, height: 1080, value: gamePlayPortraitVideoName, setValue: setGamePlayPortraitVideoName },
                ]
            },
        }
    ]

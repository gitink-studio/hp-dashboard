...
import { CREATE_SDK_INTEGRATION_DATA_URL, CURRENT_SDK_SETUP_STATE_ID, HttpMethod, WEB_GAME_SUBMISSION_SETUP_CURRENT_STATE_UPDATE_URL } from '../../../common/constants';
...
export const PlatformRequirementsStep = (): JSX.Element => {
    ...
    const steps = [
        { name: 'Meta', component: <MetaRequirementsTab />, isPlatformSelected: isMetaSelected },
        { name: 'Poki', component: <PokiRequirementsTab />, isPlatformSelected: isPokiSelected },
        { name: 'Crazy Games', component: <CrazyGamesRequirementsTab />, isPlatformSelected: isCrazyGamesSelected },
        { name: 'MSN', component: <MSNRequirementsTab />, isPlatformSelected: isMsnSelected },
    ];

...
export const GameSubmissionDetailedView = () => {
    ...
    let isPublisher = AuthenticationProvider.isRolePublisher();
    ...
    const handleDownload = async (data: any) => {
        const response = await sendRequestForDownloadFiles(DOWNLOAD_WEB_GAME_CREATIVES_DATA_URL, data);
    ...
    const getGamePlatformNameByUrl = (buildUrl: string, suffixName: string) => {
        ...
        const splitUrl: any = buildUrl.split('/');

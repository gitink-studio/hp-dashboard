...
import { useDataSending, useDisplayGamePostSubmissionDetails, useGameRequestDetails, useGameSubmissionActions, useReviewNotes } from "../../store/game-submission/game-submission-store";
...
export const GamePostSubmissionDetailedView = () => {
    ...
    const { setDisplayGamePostSubmissionDetails, setDataSending, setReviewNotes } = useGameSubmissionActions();

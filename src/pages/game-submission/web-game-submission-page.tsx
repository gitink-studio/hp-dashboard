...
import { useDataSending, useDetailedView, useOpenVideo, useGameSubmissionActions, useReviewNotes, useVideoUrl } from '../../store/game-submission/game-submission-store';
...
export const WebGameSubmissionPage = () => {
    ...
    const { setDetailedView, setGameRequestDetails, setOpenVideo, setDataSending, setVideoUrl } = useGameSubmissionActions();

...
import { useDataSending, useDisplayGamePostSubmissionDetails, useDetailedView, useGameRequestDetails, useGameRequests, useGameSubmissionActions } from '../../store/game-submission/game-submission-store';
...
export const GamePostSubmission = () => {
    ...
    const { setGameRequests, setGameRequestDetails, setDataSending, setDisplayGamePostSubmissionDetails } = useGameSubmissionActions();

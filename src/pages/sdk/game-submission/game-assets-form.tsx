...
import { useGameIconUrl, useGamePlayVideoUrl, useGameSubmissionActions, useStoreStatus } from "../../../store/sdk/game-submission-store";
...
const GameAssetsForm = () => {
    ...
    const { setGameIconUrl, setGamePlayVideoUrl } = useGameSubmissionActions();

    useEffect(() => { console.log(`GameIconUrl Changed: ${gameIconUrl}`) }, [gameIconUrl]);
    ...
    const handleIconUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setGameIconUrl(file.name);
            console.log("File name: ", gameIconUrl);
